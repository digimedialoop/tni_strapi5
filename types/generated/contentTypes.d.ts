...
export interface ApiContactrequestContactrequest
  ...
  info: {
    singularName: 'contactrequest';
    pluralName: 'contactrequests';
  ...
  attributes: {
    ...
    requestTime: Schema.Attribute.DateTime;
...
export interface ApiPagedataPagedata extends Struct.SingleTypeSchema {
  collectionName: 'pagedatas';
  info: {
    singularName: 'pagedata';
    pluralName: 'pagedatas';
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cooperation: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::contactrequest.contactrequest': ApiContactrequestContactrequest;
      'api::new.new': ApiNewNew;
      'api::pagedata.pagedata': ApiPagedataPagedata;
